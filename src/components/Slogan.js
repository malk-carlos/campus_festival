...
function Slogan() {
    ...
    return (
        ...
        <div id="Slogan" className='section'>
            ...
            <p>Campus Festival 2022 in Hiroshimaのスローガンは<strong>{slogan}</strong>に決定しました！！<span id='toblog'>（詳しくは<a href={slogan_blog} target='_blank' rel='noopener noreferrer'>こちら</a>で紹介しています。）</span></p>
